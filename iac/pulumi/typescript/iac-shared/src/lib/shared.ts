...
export const hostedZoneName = config.get("hosted_zone_name") ?? '';
export const hostedZoneId = config.get("hosted_zone_id") ?? '';
export const siteHostName = config.get("site_host_name") ?? '';
...
export const apiVersion = config.get("api_version") ?? '';
